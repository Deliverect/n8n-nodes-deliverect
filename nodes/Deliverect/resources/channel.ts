...
const channelFields: INodeProperties[] = [
	...
	},
	{
		...
		description:
			...
			'<li><code>items</code> (array): List of order items. Each item should include at least <code>plu</code> (string), <code>quantity</code> (number), and <code>price</code> (number).</li>' +
			'</ul>' +
